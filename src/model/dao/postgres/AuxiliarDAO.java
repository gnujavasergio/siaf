...
public class AuxiliarDAO
    ...
    public int add(Object obj) {
        ...
        sql = "INSERT INTO auxiliares (nombreAuxiliar,fechaRegistroAuxiliar,idUsuario,idGrupo,idUnidad,codigoAuxiliar)"
                + "VALUES ('" + auxiliar.getNombre() + "',"
