...
package org.jc.swing.tabbedPane;
...
public class TabbedPaneHeader extends JTabbedPane{
    ...
    public TabbedPaneHeader() {
        left=loadImage("/org/resources/header-slash-left.png");
        right=loadImage("/org/resources/header-slash-right.png");
        buttonHighlight = loadImage("/org/resources/header-halo.png");
        background = loadImage("/org/resources/header-gradient.png");
