...
CreateShortCut "$SMPROGRAMS\SAF\SAF.lnk" "$INSTDIR\SAF.exe" "" "$INSTDIR\SAF.exe" 0 
...
Delete "$SMPROGRAMS\SAF\*.*" 

RMDir "$SMPROGRAMS\SAF\data"
RMDir "$SMPROGRAMS\SAF\data\vsiaf.tmp"
RMDir "$SMPROGRAMS\SAF\lib" 
RMDir "$SMPROGRAMS\SAF" 
RMDir "$INSTDIR" 
